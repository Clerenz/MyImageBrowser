...
public class TagDialog extends JDialog implements ActionListener {
	...
	public TagDialog(Frame owner) {
		super(owner, "Create a tag", true);

		JPanel mainPanel = new JPanel();

		tagTextField = new JTextField(25);
		...
		builder.add(tagTextField, cc.xyw(2, 2, 4));
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().equals(okayButton)) {
			...
			imgTag = new ImgTag(tagTextField.getText());
		}
		this.dispose();
	}
