...
public class PersonDialog extends JDialog implements ActionListener {
	...
	private ImgPerson imgPerson = null;
	...
	public PersonDialog(Frame owner) {
		super(owner, "Create a person", true);

		JPanel mainPanel = new JPanel();

		personTextField = new JTextField(25);
		...
		builder.add(personTextField, cc.xyw(2, 2, 4));
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().equals(okayButton)) {
			...
			imgPerson = new ImgPerson(personTextField.getText());
		}
		this.dispose();
	}
